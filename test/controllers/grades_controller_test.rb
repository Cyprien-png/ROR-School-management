...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference("Grade.count") do
      post grades_url, params: { grade: { examination_id: @grade.examination_id, student_id: @grade.student_id, value: @grade.value } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { examination_id: @grade.examination_id, student_id: @grade.student_id, value: @grade.value } }
